...
- **Phase 3 plan** — reviewer loop, KB CRUD, pinned KB in prompts, comment UI polish: [`/home/assistant/.claude/plans/using-writing-plans-baseed-calm-pine.md`](/home/assistant/.claude/plans/using-writing-plans-baseed-calm-pine.md) (tag `phase-3`)
