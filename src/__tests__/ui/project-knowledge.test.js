...
describe("project knowledge helpers", () => {
  it("groups canonical knowledge by category and hides auto-promoted run assets", () => {
    const grouped = groupProjectKnowledgeEntries([
      ...
      { slug: "rsm", title: "RSM Style Guidance", category: "communications", display_category: "communications", meaningful_artifact: true },
      { slug: "plan", title: "Plan", category: "execution-plan", display_category: "plans", meaningful_artifact: true },
