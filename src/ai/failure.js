...
const PROVIDER_ABORT_RE = /\b(?:terminated|aborted before final output|aborted before final|stream aborted|stream was aborted|stream disconnected|socket hang up|und_err_socket|econnreset|premature close)\b/i;
