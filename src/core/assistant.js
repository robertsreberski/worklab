...
Return only one JSON object with this exact schema:
{
  ...
  "action_items": []
    ...
    return [
      section("Role", `${agentName || "Mickey"} is Robert's personal assistant inside Worklab.`),
  ...
  startMessage({ body, viewContext = null }) {
    ...
    const model = settings.assistant_model || settings.slack_model || "pi:openai-codex:gpt-5.5";
