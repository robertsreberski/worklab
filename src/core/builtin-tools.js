...
// appends `Task`. Claude's `TaskOutput` and `TaskStop` control helpers already
// running in the background; without them, an all-mode agent could launch a
// helper but could neither inspect nor stop it. Omitting any of these names
// makes at least one supported route silently lose native functionality when
// Worklab sends its explicit named allowlist.
