...
// Skill-rendering helpers (buildSkillIndex, formatSkillBodyWithPathNote,
// getSkillAccessDirs, inferSkillsRoot, buildSkillPathNote) moved to
// src/agent/prompt/skill-index.js as part of the agent-kernel back-import
// cleanup. Re-exported here so existing core callers keep working — new
// code should import from agent/prompt/skill-index.js directly.
export {
  buildSkillIndex,
  buildSkillPathNote,
  ...
  getSkillAccessDirs,
  inferSkillsRoot,
} from "../agent/prompt/skill-index.js";
