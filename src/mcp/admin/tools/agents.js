...
const agentCreateInput = object({
  ...
  fast_mode: boolean("Codex app fast mode. Available for codex:gpt-* agents and defaults on there."),
  ...
  subagent_mode: string("Native teammate subagent mode: disabled, advisory, or workspace"),
