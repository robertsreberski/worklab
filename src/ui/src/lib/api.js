...
export const api = {
  ...
  readFile: (query, options) => request("GET", `/files/read?${new URLSearchParams(query)}`, null, options),
  ...
  listAcpProfileSessions: (id, options) => request("GET", `/acp/profiles/${pathSegment(id)}/sessions`, null, options),
  ...
  respondAcpOperationInteraction: (id, data) => request("POST", `/acp/operations/${pathSegment(id)}/interactions`, data),
