...
export const api = {
  ...
  listAgentMemories: (name, query, options) => request("GET", `/agents/${name}/memories${query ? "?" + new URLSearchParams(query) : ""}`, null, options),
  patchAgentMemory: (name, memoryId, patch) => request("PATCH", `/agents/${name}/memories/${memoryId}`, patch),
