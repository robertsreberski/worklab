const RUN_PREVIEW_METADATA_FIELDS = [
  ...
  ["Source checkout", ["source_workdir"]],
  ["Workdir", ["workdir"]],
  ["Stage", ["stage"]],
  ["Mode", ["mode"]],
  ["Agent", ["agent_name"]],
...
export function normalizeRunPreviewInput(preview) {
  ...
  const metadata = {
    ...
    workspace_mode: input.metadata?.workspace_mode ?? preview?.workspace_mode ?? null,
    source_workdir: input.metadata?.source_workdir ?? preview?.source_workdir ?? null,
